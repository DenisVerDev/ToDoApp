        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Categories_Color", "LEN(TRIM([Color])) >= 6");
                    table.CheckConstraint("CK_Categories_Name", "LEN(TRIM([Name])) > 1");
                    table.ForeignKey(
                        name: "FK_Categories_AuthorId",
                        column: x => x.AuthorId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Tasks_Title", "LEN(TRIM([Title])) > 1");
                    table.ForeignKey(
                        name: "FK_Tasks_AuthorId",
                        column: x => x.AuthorId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
